"""Train and evaluate EfficientNet-B0 on the Southeast Asian food dataset.
...
def build_transforms():
    ...
    train_transform = transforms.Compose([
        ...
        transforms.ColorJitter(
            brightness=0.4, contrast=0.3, saturation=0.3, hue=0.02
        ),
...
# Load EfficientNet-B0 and adapt its classifier for this dataset.
...
# Run the complete two-phase EfficientNet training workflow.
def run_training():
...
def run_evaluation():
    ...
    save_evaluation_plots(labels, predictions, CLASSES, "efficientnet_b0")
